...
#ifdef WIN_TEST
    //account->Pull("SportStatus", &test1, sizeof(test1));
    *trip = 0;
    *time = '0';
     len = 0;
    *maxSpd = 0;
...
#ifdef WIN_TEST
    //account->Pull("GPS", &test1, sizeof(test1));
    *lat = 0;
    *lng = 0;
    *alt = 0;
    *utc = '0';
...
#ifdef WIN_TEST
    //account->Pull("MAG", &test1, sizeof(test1));
    *dir = 0;
    *x = 0;
    *y = 0;
    *z = 0;
...
#ifdef WIN_TEST
    //account->Pull("IMU", &test1, sizeof(test1));
    *step = 0;
    *info = '0';
    len = 0;
#endif
...
#ifdef WIN_TEST
    //account->Pull("Clock", &test1, sizeof(test1));
    *dateTime = '0';
    len = 0;
#endif
}
...
#ifdef WIN_TEST
    //account->Pull("Power", &test1, sizeof(test1));
    *usage = 0;
    * voltage = 0;
    * state = '0';
#endif
